...
interface IWSTETHInterface extends ethers.utils.Interface {
  functions: {
...
export class IWSTETH extends Contract {
  ...
  functions: {
    ...
    stEthPerToken(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
    ...
    tokensPerStEth(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
  ...
  estimateGas: {
    ...
    wrap(stETHAmount: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
