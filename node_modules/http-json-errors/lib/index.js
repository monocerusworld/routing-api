 ...
 */
const createError = (status, options) => {
    ...
    if (statusCode && CODE_CLASSES[statusCode]) {
        ...
        return new HttpError_2.HttpError(statusCode, options);
    }
};
