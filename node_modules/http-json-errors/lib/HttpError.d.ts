 ...
 */
export declare const getStatusCode: (value: string | number) => Maybe<number>;
/**
 ...
 */
export declare const parseErrorOptions: (...errorOptions: OptionsArg[]) => HttpErrorOptions;
/**
...
declare type OptionsArg = Maybe<string | number | HttpErrorOptions | HttpError>;
export {};
